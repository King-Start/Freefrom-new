...
class KeepAliveService : AccessibilityService(), SharedPreferences.OnSharedPreferenceChangeListener, View.OnTouchListener, GestureDetector.OnGestureListener, ChooseAppFloatingView.OnWindowRemoveCallback {
    ...
    //拖动时显示坐标的小提示框
    private var locationIndicatorView: TextView? = null
    ...
    private fun showLocationIndicator(y: Int) {
        ...
        if (locationIndicatorView == null) {
            ...
            try {
                windowManager.addView(locationIndicatorView, WindowManager.LayoutParams(
