...
class SettingFragment : PreferenceFragmentCompat(), Preference.OnPreferenceClickListener,
    ...
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        ...
        findPreference<Preference>(BATTERY_OPTIMIZATION_EXEMPTION)!!.onPreferenceClickListener = this
    ...
    override fun onPreferenceClick(preference: Preference): Boolean {
        when(preference.key) {
            ...
            BATTERY_OPTIMIZATION_EXEMPTION -> {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M && powerManager.isIgnoringBatteryOptimizations(requireContext().packageName)) {
    ...
    companion object {
        ...
        private const val BATTERY_OPTIMIZATION_EXEMPTION = "battery_optimization_exemption"
    }
}